...
namespace LtiLibrary.NetCore.Clients
{
    ...
    public static class SecuredClient
    {
        ...
        /// <param name="requestMessage">The requestMessage that will be send with the request.</param>
        ...
        /// <returns></returns>
        public static async Task SignRequest(HttpClient client, HttpRequestMessage requestMessage, HttpMethod method, string serviceUrl,
